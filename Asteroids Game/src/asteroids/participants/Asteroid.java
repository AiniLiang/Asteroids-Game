    ...
    public void collidedWith (Participant p)
    {
        if (p instanceof AsteroidDestroyer)
        {
            ...
            if(size==0) 
            {
                ...
                this.controller.addParticipant(new Debris(this.getX()-Math.random()*15, this.getY(), Math.random()*15, controller));
                this.controller.addParticipant(new Debris(this.getX()+Math.random()*15, this.getY(), Math.random()*15, controller));
                this.controller.addParticipant(new Debris(this.getX(), this.getY()+Math.random()*15, Math.random()*15, controller));
                demo.playbangsmall();
            }
            ...
            if (size == 1)
            {
                this.controller.addParticipant(new Asteroid(2, 0, this.getX(), this.getY(), (int)Math.random()+7, controller));
                this.controller.addParticipant(new Asteroid(2, 0, this.getX(), this.getY(), (int)Math.random()+7, controller));
                this.controller.addParticipant(new Debris(this.getX(), this.getY(), Math.random()*15, controller));
                this.controller.addParticipant(new Debris(this.getX()-Math.random()*15, this.getY(), Math.random()*15, controller));
                this.controller.addParticipant(new Debris(this.getX()+Math.random()*15, this.getY(), Math.random()*15, controller));
            ...
            if (size == 2)
            {
                this.controller.addParticipant(new Asteroid(2, 1, this.getX(), this.getY(), (int)Math.random()+4, controller));
                this.controller.addParticipant(new Asteroid(2, 1, this.getX(), this.getY(), (int)Math.random()+4, controller));
                this.controller.addParticipant(new Debris(this.getX(), this.getY(), Math.random()*15, controller));
                this.controller.addParticipant(new Debris(this.getX()-Math.random()*15, this.getY(), Math.random()*15, controller));
                this.controller.addParticipant(new Debris(this.getX()+Math.random()*15, this.getY(), Math.random()*15, controller));
